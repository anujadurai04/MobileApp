...
<header class="header">
  <div class="logo-wrap">
    <a href="../cart/"><i class="iconly-Arrow-Left-Square icli"></i></a>
...
<footer class="footer-wrap footer-button">
  <a href="../order_success/" class="font-md">Confirm Payment</a>
</footer>
<!-- Footer End -->
      ...
      <div class="row">
        <div class="col-6">
          <div class="input-box mb-0">
            ...
            <input class="form-control digits expriydate" type="text" data-language="en" placeholder="Expiry Date" />
          </div>
        </div>
        <div class="col-6">
          <div class="input-box mb-0">
