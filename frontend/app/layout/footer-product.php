    	...
    	<ul class="footer">
    		<li class="footer-item">
    			<div class="plus-minus">
    				...
    				<input type="number" id="qty-<?php echo $gdm_prod_id ?>" name="qty" value="0" min="<?php echo $gdm_prod_min_qty; ?>" readonly />
    				<i class="add" data-feather="plus"></i>
    			</div>
    		</li>
    		<li class="footer-item">
    			<a href="#" id="checkout_cart" class="font-md">View Cart <i data-feather="chevron-right"></i></a>
    		</li>
    	</ul>
    </footer>
    <!-- Footer End -->
    ...
    <script>
    	...
    	function displayCart() {
    		...
    		var productId = $('#qty-' + <?php echo $gdm_prod_id ?>).attr('id')?.split('-')[1];
    		var qtyInput = $('#qty-' + <?php echo $gdm_prod_id ?>);
    	...
    	$('.add').on('click', function() {
    		...
    		var proID = parseInt(<?php echo json_encode($gdm_prod_id); ?>);
    		var qtyInput = $('#qty-' + proID);
    		var qty = parseInt(qtyInput.val());
    		var minQty = parseInt(qtyInput.attr('min'));
    		var name = <?php echo json_encode($gdm_prod_name); ?>;
    		var price = <?php echo json_encode($finalPrice); ?>;
    		var offer = <?php echo json_encode($gdm_prod_offer); ?>;
    		var productimage = <?php echo json_encode($imageFproduct); ?>;
