...
<main class="main-wrap shop-page mb-xxl">
	...
	<div class="tab-content ratio2_1" id="pills-tabContent">
		...
		?>
				...
				<div class="tab-pane hai fade <?php if ($catID == $catIDURL) { ?>show active<?php } ?>" id="catagories-<?php echo $catID ?>" role="tabpanel" aria-labelledby="<?php echo $catID ?>-tab">
					<?php
					...
					?>
							<div class="tab-pane hai fade <?php if ($jbrand_id == $brandIDURL) { ?>show active<?php } else { ?>hideactive <?php } ?>" id="brandid-<?php echo $jbrand_id ?>" role="tabpanel" aria-labelledby="brand<?php echo $jbrand_id ?>-tab">
								<?php
								$prodSQL = mysqli_query($link, "SELECT * FROM gdm_products INNER JOIN jdm_brand on gdm_prod_brand_id=jdm_brand_id WHERE gdm_prod_cat_id = '$catID' AND gdm_prod_brand_id='$jbrand_id'");
...
<?php include '../../layout/footer-offer.php' ?>
